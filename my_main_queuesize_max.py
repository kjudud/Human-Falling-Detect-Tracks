...
if __name__ == '__main__':
    ...
    acc_activity_save_dir = f'max_result/queue_{args.queue_size}'
                ...
                if len(track.keypoints_list) == 30:
                    ...
                    if args.note_acc:
                        ...
                        if out_save_list.shape[0] == (action_win+1):
                            ...
                            out_list_max_out = np.argmax(out_save_list,axis = None)
                            out_list_max_out = out_list_max_out % 7   
                            if (decision==0) and (out_list_max_out == 6):
                                avg_result_path = os.path.join(acc_activity_save_dir, f'acc-avtivity-{activity}.txt')
